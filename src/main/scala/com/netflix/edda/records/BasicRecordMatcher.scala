...
class BasicRecordMatcher extends RecordMatcher {
  ...
  protected def cmpPartialMatcher: PartialFunction[(Any, Any), Int] = {
    ...
    case (found: Float, expected: Double) if expected.toFloat.toString.toDouble == expected =>
      found.compareTo(expected.toFloat)
    ...
    case (found: Long, expected: Double) if expected.toLong.toDouble == expected =>
      found.compareTo(expected.toLong)
    case (found: Long, expected: Float) if expected.toLong.toFloat == expected =>
      found.compareTo(expected.toLong)
    ...
    case (found: Int, expected: Double) if expected.toInt.toDouble == expected =>
      found.compareTo(expected.toInt)
    case (found: Int, expected: Float) if expected.toInt.toFloat == expected =>
      found.compareTo(expected.toInt)
    case (found: Int, expected: Long) if expected.toInt.toLong == expected =>
      found.compareTo(expected.toInt)
    ...
    case (found: Short, expected: Double) if expected.toShort.toDouble == expected =>
      found.compareTo(expected.toShort)
    case (found: Short, expected: Float) if expected.toShort.toFloat == expected =>
      found.compareTo(expected.toShort)
    case (found: Short, expected: Long) if expected.toShort.toLong == expected =>
      found.compareTo(expected.toShort)
    case (found: Short, expected: Int) if expected.toShort.toInt == expected =>
      found.compareTo(expected.toShort)
    case (found: Short, expected: Short) => found.compareTo(expected)
    case (found: Short, expected: Byte)  => found.compareTo(expected)

    case (found: Char, expected: Long) if expected.toString.size == 1 =>
      found.compareTo(expected.toString.head)
    case (found: Char, expected: Int) if expected.toString.size == 1 =>
      found.compareTo(expected.toString.head)
    case (found: Char, expected: Short) if expected.toString.size == 1 =>
      found.compareTo(expected.toString.head)
    case (found: Char, expected: Char) => found.compareTo(expected)
    case (found: Char, expected: Byte) if expected.toChar.toByte == expected =>
      found.compareTo(expected.toChar)

    case (found: Byte, expected: Long) if expected.toByte.toLong == expected =>
      found.compareTo(expected.toByte)
    case (found: Byte, expected: Int) if expected.toByte.toInt == expected =>
      found.compareTo(expected.toByte)
    case (found: Byte, expected: Short) if expected.toByte.toShort == expected =>
      found.compareTo(expected.toByte)
    case (found: Byte, expected: Char) if expected.toByte.toChar == expected =>
      found.compareTo(expected.toByte)
  ...
  protected def noPartialMatch: PartialFunction[(Any, Any), Int] = {
    case (found, expected) =>
      throw new java.lang.RuntimeException(
        "no comparitor found for: " + found + " compareTo " + expected
      )
  }
