...
abstract class Crawler extends Observable {
  ...
  lazy val enabled = Common.getProperty("edda.crawler", "enabled", name, "true")
  lazy val jitter = Common.getProperty("edda.crawler", "jitter.enabled", name, "false")
  lazy val throttle = Common.getProperty("edda.crawler", "throttle.enabled", name, "false")
  lazy val throttle_delay = Common.getProperty("edda.crawler", "throttle.delay", name, "200")
  lazy val retry_max = Common.getProperty("edda.crawler", "throttle.maxDelayMultiplier", name, "225")
  lazy val request_delay = Common.getProperty("edda.crawler", "requestDelay", name, "0")
