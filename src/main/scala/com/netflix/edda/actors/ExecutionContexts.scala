...
object ThreadPools {
  ...
  val queryPool: ExecutorService = Executors.newFixedThreadPool(200)
  ...
  val observerPool: ExecutorService = Executors.newFixedThreadPool(5)
  DefaultMonitorRegistry
    .getInstance()
    .register(
  ...
  var purgePool: ExecutorService = Executors.newFixedThreadPool(1)
  DefaultMonitorRegistry
    .getInstance()
    .register(
      Monitors
  ...
  val electorPool: ExecutorService = Executors.newFixedThreadPool(10)
  DefaultMonitorRegistry
    .getInstance()
    .register(
      Monitors.newThreadPoolMonitor(
